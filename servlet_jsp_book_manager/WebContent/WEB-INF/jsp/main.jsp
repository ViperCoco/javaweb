			...
			<tr>
				...
				<c:choose>
					...
					<c:when test="${book.borrow_date == '尚未借出' }">
						...
						<td align="center"><a
							href="borrow.do?id=${book.id }&page=${page}"><input
								type="button" name="button" id="button" value="借出"
								style="background: #0F6"></a></td>
					...
					<c:otherwise>
						...
						<td align="center"><input type="button" name="button"
							id="button" value="归还" style="background: #F06"></td>
